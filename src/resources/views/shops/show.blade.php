...
<section class="p-shop-detail" aria-labelledby="shop-title">
    <div class="p-shop-detail__layout">
        {{-- 左：店舗情報 --}}
        <div class="p-shop-detail__left">
        ...
        {{-- 右：予約関連（フォーム + 今後の予約） --}}
        <aside class="p-shop-detail__right" aria-labelledby="reserve-title">
            ...
            <form action="{{ route('reservations.store') }}" method="post" class="c-form" novalidate>
                ...
                <div class="c-form__field">
                    ...
                    <label class="c-radio">
                        <input type="radio" name="payment_method" value="none"
                            {{ old('payment_method','none') === 'none' ? 'checked' : '' }}>
                        来店時に支払い
                    </label>
                    <label class="c-radio">
                ...
                <aside class="p-shop-detail__reserve-preview" aria-label="予約内容">
                    ...
                    <dl class="p-shop-detail__reserve-list">
                        <div class="p-shop-detail__reserve-item"><dt>店舗名</dt><dd>{{ $shop->name }}</dd></div>
                        <div class="p-shop-detail__reserve-item"><dt>予約日</dt><dd>{{ old('reserve_date') }}</dd></div>
                        <div class="p-shop-detail__reserve-item"><dt>予約時間</dt><dd>{{ old('reserve_time') }}</dd></div>
                        <div class="p-shop-detail__reserve-item"><dt>予約人数</dt><dd>{{ old('number_of_people', 1) }}人</dd></div>
                    </dl>
                </aside>
